...
bool yahboom_msgs__msg__image_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yahboom_msgs.msg._image_msg.ImageMsg", full_classname_dest, 36) == 0);
  }
  yahboom_msgs__msg__ImageMsg * ros_message = _ros_message;
  {  // height
...
PyObject * yahboom_msgs__msg__image_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yahboom_msgs.msg._image_msg");
