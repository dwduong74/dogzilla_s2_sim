...
#ifndef YAHBOOM_MSGS__MSG__DETAIL__TARGET__TRAITS_HPP_
#define YAHBOOM_MSGS__MSG__DETAIL__TARGET__TRAITS_HPP_
...
inline void to_yaml(
  const yahboom_msgs::msg::Target & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const yahboom_msgs::msg::Target & msg)
{
  return yahboom_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<yahboom_msgs::msg::Target>()
{
  return "yahboom_msgs::msg::Target";
}

template<>
inline const char * name<yahboom_msgs::msg::Target>()
{
  return "yahboom_msgs/msg/Target";
}

template<>
struct has_fixed_size<yahboom_msgs::msg::Target>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<yahboom_msgs::msg::Target>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<yahboom_msgs::msg::Target>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // YAHBOOM_MSGS__MSG__DETAIL__TARGET__TRAITS_HPP_
