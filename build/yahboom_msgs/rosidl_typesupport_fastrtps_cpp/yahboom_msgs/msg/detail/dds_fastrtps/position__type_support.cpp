...
#include "yahboom_msgs/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yahboom_msgs::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yahboom_msgs::msg::Position & ros_message)
{
  // Member: anglex
  cdr >> ros_message.anglex;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yahboom_msgs::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yahboom_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yahboom_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  return &yahboom_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yahboom_msgs, msg, Position)() {
  return &yahboom_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
