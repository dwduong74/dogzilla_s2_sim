...
#include "yahboom_msgs/msg/detail/target__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yahboom_msgs::msg::Target & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yahboom_msgs::msg::Target & ros_message)
{
  // Member: frame_id
  cdr >> ros_message.frame_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yahboom_msgs::msg::Target;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yahboom_msgs::msg::Target *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yahboom_msgs::msg::Target *>(
    untyped_ros_message);
...
{
  return &yahboom_msgs::msg::typesupport_fastrtps_cpp::_Target__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yahboom_msgs, msg, Target)() {
  return &yahboom_msgs::msg::typesupport_fastrtps_cpp::_Target__handle;
}
