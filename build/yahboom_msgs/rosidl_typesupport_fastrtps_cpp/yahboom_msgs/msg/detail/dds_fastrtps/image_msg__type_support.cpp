...
#include "yahboom_msgs/msg/detail/image_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yahboom_msgs::msg::ImageMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yahboom_msgs::msg::ImageMsg & ros_message)
{
  // Member: height
  cdr >> ros_message.height;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yahboom_msgs::msg::ImageMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yahboom_msgs::msg::ImageMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yahboom_msgs::msg::ImageMsg *>(
    untyped_ros_message);
...
{
  return &yahboom_msgs::msg::typesupport_fastrtps_cpp::_ImageMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yahboom_msgs, msg, ImageMsg)() {
  return &yahboom_msgs::msg::typesupport_fastrtps_cpp::_ImageMsg__handle;
}
