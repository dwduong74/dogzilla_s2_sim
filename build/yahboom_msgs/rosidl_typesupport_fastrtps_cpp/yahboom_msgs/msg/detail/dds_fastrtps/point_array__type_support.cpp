...
#include "yahboom_msgs/msg/detail/point_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yahboom_msgs::msg::PointArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yahboom_msgs::msg::PointArray & ros_message)
{
  // Member: points
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yahboom_msgs::msg::PointArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yahboom_msgs::msg::PointArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yahboom_msgs::msg::PointArray *>(
    untyped_ros_message);
...
get_message_type_support_handle<yahboom_msgs::msg::PointArray>()
{
  return &yahboom_msgs::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yahboom_msgs, msg, PointArray)() {
  return &yahboom_msgs::msg::typesupport_fastrtps_cpp::_PointArray__handle;
}
