...
static const _ImageMsg_type_support_symbol_names_t _ImageMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yahboom_msgs, msg, ImageMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yahboom_msgs, msg, ImageMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yahboom_msgs, msg, ImageMsg)() {
  return &::yahboom_msgs::msg::rosidl_typesupport_c::ImageMsg_message_type_support_handle;
}
