...
{
  new (message_memory) yahboom_msgs::msg::ImageMsg(_init);
}

void ImageMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yahboom_msgs::msg::ImageMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ImageMsg_message_member_array[4] = {
  {
    ...
    offsetof(yahboom_msgs::msg::ImageMsg, height),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboom_msgs::msg::ImageMsg, width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboom_msgs::msg::ImageMsg, channels),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yahboom_msgs::msg::ImageMsg, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ImageMsg_message_members = {
  ...
  4,  // number of fields
  sizeof(yahboom_msgs::msg::ImageMsg),
...
get_message_type_support_handle<yahboom_msgs::msg::ImageMsg>()
{
  return &::yahboom_msgs::msg::rosidl_typesupport_introspection_cpp::ImageMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yahboom_msgs, msg, ImageMsg)() {
  return &::yahboom_msgs::msg::rosidl_typesupport_introspection_cpp::ImageMsg_message_type_support_handle;
}
